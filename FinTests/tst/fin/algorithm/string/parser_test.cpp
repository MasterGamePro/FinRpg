...
namespace fin::algorithm {
  ...
  TEST_METHOD( TestParser_NibbleRegex ) {
    ...
    Assert::IsFalse( parser.nibble_regex( "rye" ) );
    Assert::IsTrue( parser.nibble_regex( "cat" ) );
    Assert::IsTrue( parser.nibble_regex( "" ) );
    Assert::IsTrue( parser.nibble_regex( "c" ) );
    Assert::IsFalse( parser.nibble_regex( "herr" ) );
    Assert::IsTrue( parser.nibble_regex( "[her]*" ) );
    Assert::IsTrue( parser.nibble_regex( "\\sin " ) );
    Assert::IsTrue( parser.nibble_regex( "(the) " ) );
    Assert::IsTrue( parser.nibble_regex( "[r]?ye" ) );
    Assert::IsTrue( parser.nibble_regex( "[ ]*" ) );
